...
They consist of a generator G θ : R n → R m and a discriminator D φ : R m → R, where n is the dimension of a latent space with probability distribution P z and m is the dimension of the data distribution P d , which is equal to width × height × #colors in the case of images.
