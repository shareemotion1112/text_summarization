...
The discount factor γ t to apply to the previous values in the average DISPLAYFORM2 where σ is the sigmoid/logistic function defined as σ( DISPLAYFORM3 We use these values to calculate a discounted moving average.
