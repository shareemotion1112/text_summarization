...
Knowledge Distillation (Figure 4b ) (Bucilȃ et al., 2006; Hinton et al., 2015) (or simply "distillation") transfers information from a highly-parameterized and accurate teacher model to a more compact and thus less expressive student.
...
Many previous distillation efforts focus on tasks where the two sets come from the same distribution (Romero et al., 2014; Hinton et al., 2015) , while others simply acknowledge the importance of and strive for a close match between them (Bucilȃ et al., 2006) .
...
Learning compact models In this work we built on model compression (Bucilȃ et al., 2006) and its variant knowledge distillation (Hinton et al., 2015) .
...
Prior works have also noted the unavailability of in-domain large-scale transfer data and proposed the use of automatically generated pseudo-examples (Bucilȃ et al., 2006; Kimura et al., 2018) .
