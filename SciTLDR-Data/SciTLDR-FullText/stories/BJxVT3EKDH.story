...
The word ጉርሻ/"feed in other people with hands which expresses love and live in harmony with others"/ in the Amharic text: "እንደ ጉርሻ ግን የሚያግባባን የለም. . .

ጉርሻ እኮ አንዱ ለሌላው የማጉረስ ተግባር ብቻ አይደለም፤ በተጠቀለለው እንጀራ ውስጥ ፍቅር አለ፣ መተሳሰብ አለ፣ አክብሮት አለ።" has positive connotation or positive sentiment.
...
where β is the factor that is responsible for preserving the overall semantic orientations between positive and negative flow over the graph.
...
Compute the cosine distance between target term and centroid of seed lists (e.g. centroid for positive adjective seeds, − − → µ + adj ).
...
After we have cosine distances between word w i and seed with centroid w i , µ + adj , the similarity measure can be found using either:

Similarly, the similarity score, Sim( w i , − − → µ − adj ) can also be computed.
...
Sample of this lexicon is presented in Table 2 . ['ሀሰተኛ/lair/, ሀሰት/fake/, የሀሰት/fake/, ከሀሰተኛ/from fake maker/, ሀሰተኛና/lair and/, የሀሰተኛ/for fake maker/, ለሀሰተኛ/to lair/, ሀሴት/pleasure/, ታህሳት//, ሀሰትነት/fakeness/, ሀሰትን/fake/ , ከሀሰተኛው/from the lair/, ሀሰተኛው/lair/, ሀሰቱን/lair/, ከሀሰት/from lair/, ሀሰትና/fake and/, ከሀሰቱ/from the fake/, ሀሴትና/pleasure and/, ሀሴትን/the pleasure/, ሀሳት/fake/, ለሀሰትና/to fake and/, ሁሰት//, የሀሰትና/for fake and/, ለሀሰት/to fake/, ሀሰቶች/alot of fake/,etc.
