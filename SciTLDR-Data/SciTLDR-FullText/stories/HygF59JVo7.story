...
We 114 relaxed the arg max operator to a differentiable softmax function with temperature parameter τ : DISPLAYFORM0 The τ parameter is annealed exponentially from τ = 1 to τ = 0.5 as the training iterations progresses.
