...
FIG1 shows an example of a generated SuperTML image, created using Iris data.
...
One example of a SuperTML image created using data from this dataset is shown in FIG1 .
...
In this challenge, AMS score ( is used as the performance metric.

FIG3 shows two examples of generated SuperTML images.
