...
Friedman rank sum tests showed only one difference between mappings -people saw themselves as being less successful with the Apps mapping (χ 2 =7, p=0.030).
...
We did find a significant main effect of Position (F2,28=19.68, p<0.0001, η 2 =0.22), but as shown in Figure 8 , the second and third mappings were actually faster than the first mapping.
...
The difference was more obvious in the early blocks (indicated by a significant interaction between Position and Block, F18,252=4.63, p<0.0001, η 2 =0.14).
...
ANOVA showed a main effect of Position on accuracy (F2,28=7.18, p=0.003, η 2 =0.072), but with no Position x Block interaction (F18,252=1.20, p=0.051).
