...
Another option to solve the huge search space is to use a search algorithm such as Tabu search (Glover & Laguna, 1998) or variable neighborhood search (Mladenović & Hansen, 1997) , to find a global plausible solution (Balliauw et al., 2015; .
...
Object Detection (Viola & Jones, 2001; Redmon et al., 2016; Lin et al., 2017a; b) , and specifically Hand Detection Kölsch & Turk, 2004; Sridhar et al., 2015) are well studied subjects.
...
We chose to estimate the pressed fingers as a Gaussian distribution N (µ, σ 2 ), where µ and σ are defined as follows:

µ is the center of the key on the x axis and σ is its width.
...
Σ n l=1 0.5 l Figure 3 : Precision and recall based on confidence for all 6,894 manually tagged notes
