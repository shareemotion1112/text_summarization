...
All the λ g 's are initialized to zero.

At each iteration, λ g is increased by λ new g = max(λ g + ∆λ g , 0).

Like AFP BID6 , we agree that unimportant weights should be punished more, so we propose a decreasing piece-wise linear punishment function (Eqn.1, FIG0 ) to determine ∆λ g .
