...
Formally, we create 2 multilayer perceptrons: a learner L(· | φ L ) with parameters φ L and a metalearner M (v i , v j , w ij | φ M ) with parameters φ M , which takes inputs v i , w ij , v j and returns ∆w ij .
