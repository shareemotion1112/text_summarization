...
Unsupervised Objectives Currently, the library includes implementations of the following unsupervised variational algorithms: VAE (Kingma and Welling, 2014), β-VAE (Fertig et al., 2018) , β-TCVAE (Chen et al., 2018), Factor-VAE (Kim and Mnih, 2018) , Info-VAE (Zhao et al., 2017) , DIP-I-VAE, and DIP-II-VAE (Kumar et al., 2018) .
...
The β-TCVAE algorithm achieved the best disentanglement results on the mpi3d real dataset in the second stage of the disentanglement challenge.
...
The β value of the β-TCVAE objective function was set to 2.
...
Disentanglement performance, on the available samples of the mpi3d realistic dataset, is visualized in Appendix A. Figure 1 : Latent factor traversal of the trained β-TCVAE model on a random sample of the mpi3d realistic dataset.
