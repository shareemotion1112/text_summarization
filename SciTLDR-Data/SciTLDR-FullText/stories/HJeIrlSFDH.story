...
On the other hand, Google Translate misinterprets the word "bank" in the sentence "A fisherman is sitting on the bank." and thus translates it into "漁 師が銀 銀 銀行 行 行に座っています。".
...
By contrast, the two models Transformer BERT−WE and Transformer BERT−Encoder can correctly translate the word "bank" into "土手" or "岸", which means "the edge of a river" in Japanese.
