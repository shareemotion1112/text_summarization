...
The weights R are initialized as a random perturbation of the identity to ensure smooth trajectories: R 0 = (1 − ε)I + εJ where ε = .01 and I is the identity matrix.
...
The equation for the ED of a set of points is ED = 1/ iλ 2 i whereλ i = λ i / j λ j are the normalized eigenvalues of the covariance matrix of the points.
