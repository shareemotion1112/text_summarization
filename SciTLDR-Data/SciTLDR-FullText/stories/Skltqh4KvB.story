...
The CCMAS for class A compares the mean activation of all images in class A, µ A , with the mean activation of all images not in class A, µ ¬A , and is given by:
