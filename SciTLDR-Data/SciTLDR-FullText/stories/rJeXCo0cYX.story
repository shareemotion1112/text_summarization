...
In all our experiments, we used the Adam optimizer BID20 with the hyperparameters α = 10 −4 , β 1 = 0.9, β 2 = 0.999 and = 10 −5 .
...
The reward future returns were discounted without a factor γ = 0.99.

For generalized advantage estimation BID29 in PPO we used λ = 0.99.In all our experiments we reported the success rate, defined as the ratio of missions of the level that the agent was able to accomplish within n max steps.
