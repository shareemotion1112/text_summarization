...
A preliminary study showed that almost 30% of all the OPIEC triples containing the same recognized Triple length in tokens (µ ± σ) 7.66 ± 4.25 6.06 ± 2.82 6.45 ± 2.65 subject (µ ± σ) 2.12 ± 2.12 1.48 ± 0.79 1.92 ± 0.94 relation (µ ± σ) 3.01 ± 2.47 3.10 ± 2.56 2.77 ± 2.14 object (µ ± σ) 2.52 ± 2.69 1.48 ± 0.79 1.76 ± 0.94Confidence score (µ ± σ) 0.53 ± 0.23 0.59 ± 0.23 0.61 ± 0.26 Table 2 : Statistics for different OPIEC corpora.
