...
A reasoner is then equipped with a set Rules of strict rules, denoted φ 1 , . . .

, φ n → φ, and defeasible rules, denoted φ 1 , . . .

, φ n ⇒ φ, where φ 1 , . . .

, φ n , φ are all elements of L. A knowledge base ∆ is then a set of elements K from L and a set Rules.
...
, A n → φ if A i , 1 ≤ i ≤ n, are arguments and there exists a strict rule of the form Conc(A 1 ), . . .

, DISPLAYFORM1 • A 1 , . . .

, A n ⇒ φ if A i , 1 ≤ i ≤ n, are arguments and there exists a defeasible rule of the form Conc(A 1 ), . . .
