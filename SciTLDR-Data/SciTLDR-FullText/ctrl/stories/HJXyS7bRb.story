...
Let θ s to represent the parameter set of service agent model and θ c to the parameter set of the customer model, Equation 5 is the loss function of the supervised model.
...
During training, we also use a reward discount γ to distribute contributions of the rewards to earlier time steps.
