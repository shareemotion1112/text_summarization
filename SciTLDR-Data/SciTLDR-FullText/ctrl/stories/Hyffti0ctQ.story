...
Using taylor expansion can get approximate formula of the objective function: DISPLAYFORM2 During backpropagation, we can get gradient δC δhi and activation h i .
...
λ is hints loss weight which determines the intensity of hints supervision.
