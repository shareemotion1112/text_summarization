...
By definition, w i = φ, if node i is in the first layer.
...
where, η is the gradient step-size and ∂L ∂ w k is the gradient of the loss function of the neural network along w k
...
For any two points, w 1 and w 2 ∃γ : [0, 1] −→ U, such that:
