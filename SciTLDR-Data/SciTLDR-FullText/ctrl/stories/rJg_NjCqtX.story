...
For the decoder, it gives the probability of an output sequenceŷ = {ŷ i }: DISPLAYFORM1 and for a single tokenŷ t , the probability is calculated by DISPLAYFORM2
