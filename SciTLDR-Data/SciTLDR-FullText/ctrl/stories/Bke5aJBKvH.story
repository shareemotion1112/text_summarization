...
Considering the sequence of contexts previously fed into LSTM through the cascades of convolution operations and memory mechanism of LSTM until l-th layer, h l infers the layer attention, α l ∈ [0, 1], the scalar value for scaling the feature volume A l :

where F att is composed of two fully-connected layers with

r .

δ and σ refer to the ReLU (Nair & Hinton, 2010) and sigmoid operations, respectively.

Reduction ratio r denotes compressing ratio of the first fully-connected layer.

Finally, the scaled feature volumeÃ l is computed by element-wise multiplication F scale between α l and all elements of A l :
