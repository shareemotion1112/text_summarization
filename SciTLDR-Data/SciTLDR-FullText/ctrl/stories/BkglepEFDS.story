...
Note that a high value of θ encourages D s and D T place higher values on G S x S and G T x T respectively.
...
The trade-off parameters α, β, γ, λ are in {10 −1 , 10 −2 , 10 −3 }, θ is in {0, 1} and 1/(2σ 2 ) is in {2 −10 , 2 −9 }.
