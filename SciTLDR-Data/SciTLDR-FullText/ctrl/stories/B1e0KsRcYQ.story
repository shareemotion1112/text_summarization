...
proposed Compact Bilinear Pooling that tackles the high dimensionality of second-order features by analyzing two low-rank approximations of the equivalent polynomial kernel (equation FORMULA1 from ): DISPLAYFORM0 with φ the mapping function that approximates the kernel.
