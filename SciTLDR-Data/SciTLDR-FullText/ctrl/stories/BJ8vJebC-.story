...
Czech Our Czech errors come from manually annotated essays written by non-native speakers (Šebesta et al., 2017) .

Here, the authors found an incredibly diverse set of errors, and therefore phenomena of interest: capitalization, incorrectly replacing voiced and voiceless consonants (e.g. z/s, g/k), missing palatalization (matǩe/matce), error in valence, pronominal reference, inflection, colloquial forms, and so forth.
