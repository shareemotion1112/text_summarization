...
λ is a hyper-parameter to balance these two parts.
...
α and β are two variables to balance these two loss terms.
...
Here, the hyper-parameters α and β are set to 1 and 10 respectively.
...
The value α:β require to be determined before tracking.
