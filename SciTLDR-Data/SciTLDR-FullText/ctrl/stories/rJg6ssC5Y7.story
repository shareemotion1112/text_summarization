...
The learning rate α was tuned for each optimizer and test problem individually, by evaluating on a logarithmic grid from α min = 10 −5 to α max = 10 2 with 36 samples.
