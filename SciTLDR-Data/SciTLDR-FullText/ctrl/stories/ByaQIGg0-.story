...
DISPLAYFORM0 The parameters present are n 1 , n 2 , A i s, and h. We also add the parameter θ that determines the angle of attack.
...
S(φ, y) = φ n1 (1 − φ) This tells the height of the airfoil at a point (x, y).
...
We also have 2 parameters for the angle θ and ψ that determine the rotation in the x and y direction.

We keep ψ at zero and only vary θ at the desired angles during the optimization.
