...
, guarantees that all pairs of classes c i and c j are distinguishable from each other with probability greater than 1 − δ 1 .
...
If the best class i * has p i * > α and we primarily care for recovering p i * with high probability, then we have RB > and classes i and j are the first and second best respectively (p i > p j > p k f or every k = i, j),
