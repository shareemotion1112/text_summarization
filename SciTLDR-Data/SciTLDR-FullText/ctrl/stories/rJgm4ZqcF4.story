...
The scheduler is given• a list of activities A 1 p 1 , d 1 , R 1 , e 1 , dv 1 , Γ 1 , T 1 , D 1 . . .

A n p n , d n , R n , e n , dv n , Γ n , T n , D n• where p i is the scheduling priority of activity A i ;• d i is the nominal, or predicted, duration of activity A i ;• R i is the set of unit resources R i1 . . .

R im that activity A i will use;• e i and dv i are the rates at which the consumable resources energy and data volume respectively are consumed by activity A i ;• Γ i1 . . .

Γ ir are non-depletable resources used such as sequence engines available or peak power for activity A i ;• T i is a set of start time windows [T ij start , T i j pref erred , DISPLAYFORM0 • D i is a set of activity dependency constraints for activity A i where A p → A q means A q must execute successfully before A p starts.
