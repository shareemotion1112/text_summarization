...
The k-th largest eigenvalue and corresponding eigenvector of M PPMI are denoted as λ k and u k ∈ R |V | , and the k-th column of W SGNS as v k ∈ R |V | .
...
The empirical distribution of eigenvector elements u k is compared with a Normal distribution N(µ u k , σ 2 u k ) to measure normality of the eigenvectors, where µ u k , σ 2 u k refer to the mean and variance of u k .
...
FIG1 illustrates the IPR of u k plotted against the corresponding eigenvalue λ k , and vice versa for v k .
