...
More precisely, let model (x) be the class evidence (logit) as a function of the input x and let δ i be spatially separated and non-overlapping input modifications.
