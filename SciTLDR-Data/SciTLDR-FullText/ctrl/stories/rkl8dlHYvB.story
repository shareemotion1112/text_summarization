...
Calculate the rectification score r ij ← R(P i , P j ) 5: end for 6: Calculate policy π(P i , P j ) ← Sample pair P i , P j ∼ π(P i , P j ) 9: else 10:

Select the P i , P j = arg max π(P i , P j ) 11: end if 12: if V (P i , P j ) is True then 13:
...
We define the policy π(P i , P j |P) as a distribution over all possible pairs characterized by a softmax layer as shown in line 6 of Algorithm 1.
...
Then we conduct a grid search on the 300 instances regarding the parameters (θ 1 , θ 2 , θ 3 , σ) in WCSeg.
...
We eventually select (θ 1 = 0.950, θ 2 = 0.704, θ 3 = 0.403, σ = 0.069) for Level-1, (θ 1 = 1.426, θ 2 = 0.845, θ 3 = 0.504, σ = 0.086) for Level-2, and (θ 1 = 1.188, θ 2 = 0.563, θ 3 = 0.504, σ = 0.069) for Level-3 in our experiments.
