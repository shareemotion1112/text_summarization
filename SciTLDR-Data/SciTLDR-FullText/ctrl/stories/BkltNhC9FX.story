...
Here A θ (., .) is an end-to-end trained function of input state x a and decoder state s t .
...
These models utilize an index based coupling between attention positions of the form DISPLAYFORM1 where A θ (x at , s t ) is the attention logit computed from the previous RNN step, k(a t , a t−1 ) is the attention coupling energy and Z is the normalization constant.

In the proximity based attention the coupling energy k(a t , a t−1 ) is given by I(|a t − a t−1 | < 3)δ at−at−1 .
...
As the name implies, in this method k(a t , a t−1 ) is a monotonic energy given by I(a t > a t−1 )δ at−at−1−1 .
