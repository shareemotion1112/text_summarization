...
Grover & Ermon (2018) introduced multiplicative boosting, which takes the geometric average of meta-models' distributions, with each assigned an exponentiated weight α i as
...
with β i ∈ [0, 1] being the hypermeter.
...
Other metamodels can be selected as VAEs (Kingma & Welling, 2013) or their variants (Burda et al., 2015; Sønderby et al., 2016) .
...
We choose ConvVAE (i.e., VAE with convolutional layers), LVAE (Sønderby et al., 2016) , IWAE (Burda et al., 2015) as advanced models, which represent current state-of-art methods.
...
All VAEs have two deterministic hidden layers for both generation, and inference and we add batch normalization layers (Ioffe & Szegedy, 2015; Sønderby et al., 2016 ) after deterministic hidden layers.
