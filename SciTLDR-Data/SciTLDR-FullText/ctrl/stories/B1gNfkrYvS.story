...
The shape of input is 8ˆ8ˆ4.

The shape of 3D kernel is 4ˆ4ˆ3.

As a result, the shape of output is 5ˆ5ˆ3.
...
The input is a tensor of 1's which has a shape of 1ˆ5ˆ5ˆp3ˆ3ˆ3q (correspond to the the input channel, input height, input width, first capsule dimension, second capsule dimension, and third capsule dimension, respectively).

The capsule kernel is also a tensor of 1's which has a shape of 4ˆ4ˆ1ˆ1ˆp3ˆ3ˆ3q -kernel height, kernel width, number of input channel, number of output channel, and the three dimensions of the 3D capsule.

As a result, we get an output tensor of 48's which has a shape of 1ˆ2ˆ2ˆp3ˆ3ˆ3q.
...
As Figure 4 shows, the basic operation of 3D convolution is f : U P R gˆmˆn Ñ v P R while the basic operation of P-CapsNet is f : U P R gˆmˆn Ñ V P R gˆmˆp .

The capsules in (Sabour et al. (2017) ) and (Hinton et al. (2018) ) are vectors and matrices.

For example, the capsules in Sabour et al. (2017) have dimensionality 1152ˆ10ˆ8ˆ16 which can convert each 8-dimensional tensor in the lower layer into a 16-dimensional tensor in the higher layer (32ˆ6ˆ6 " 1152 is the input number and 10 is the output number).

We need a total of 1152ˆ10ˆ8ˆ16 " 1474560 parameters.

If we package each input/output vector into 4ˆ2 and 4ˆ4 matrices, we need only 1152ˆ10ˆ2ˆ4 " 92160 parameters.

This is the policy adopted by Hinton et al. (2018) in which 16-dimensional tensors are converted into new 16-dimensional tensors by using 4ˆ4 tensors.

In this way, the total number of parameters is reduced by a factor of 15.

In this paper, the basic unit of input (U P R gˆmˆn ), output (V P R gˆmˆp ) and capsules (W P R gˆnˆp ) are all rank-3 tensors.

Assuming the kernel size is (khˆkw), the input capsule number (equivalent to the number of input feature maps in CNNs) is in.
...
Assuming a P-CapsNet model is supposed to fit a function f : R WˆHˆ3 Ñ R, the ground-truth label is y P R and the loss function L " ||f´y||.
...
For example, converting a 1ˆ16 tensor to another 1ˆ16 tensor, we need 16ˆ16 " 256 parameters.

In contrast, if we fold both input/output vectors to three-dimensional tensors, for example, as 2ˆ4ˆ2, then we only need 16 parameters (the capsule shape is 2ˆ4ˆ2).
...
For example, the first layer of a P-CapsNet can take 1ˆwˆhˆp1ˆ1ˆ3q tensors as the input (colored image), and take 1ˆwˆhˆp1ˆ1ˆ1q tensors as the input for gray-scale images.
...
where T k = 1 iff class k is present, and m`ě 0.5, m´ě 0 are meta-parameters that represent the threshold for positive and negative samples respectively.

λ is a weight that adjust the loss contribution for negative samples.
...
We follow the work of Sabour et al. (2017); Hinton et al. (2018) to crop 24ˆ24 patches from each image during training, and use only the center 24ˆ24 patch during testing.
...
For example, the first capsule layer has a shape of 3ˆ3ˆ1ˆ1ˆp1ˆ1ˆ16q, so we reshape it to a 9ˆ16 matrix.
...
Take CapsNets#2 as an example, the input are gray-scale images with a shape of 28ˆ28, we reshape it as a 6D tensor, 1ˆ28ˆ28ˆp1ˆ1ˆ1q to fit our P-CaspNets.

The first capsule layer (CapsConv#1, as Figure 7 shows.), is a 7D tensor, 3ˆ3ˆ1ˆ1ˆp1ˆ1ˆ16q.
...
Similarly, the five capsule layers of P-CapsNets#0 are 3ˆ3ˆ1ˆ1ˆp1ˆ1ˆ32, 3ˆ3ˆ1ˆ2p 1ˆ8ˆ8q, 3ˆ3ˆ2ˆ4ˆp1ˆ8ˆ8q, 3ˆ3ˆ4ˆ2ˆp1ˆ8ˆ8, 3ˆ3ˆ2ˆ10ˆp1ˆ8ˆ8q respectively.

The strides for each layers are p2, 1, 2, 1, 1q.

The five capsule layers of P-CapsNets#1 are 3ˆ3ˆ1ˆ1ˆp1ˆ1ˆ16, 3ˆ3ˆ1ˆ1ˆp1ˆ4ˆ6q, 3ˆ3ˆ1ˆ1ˆp1ˆ6ˆ4q, 3ˆ3ˆ1ˆ1ˆp1ˆ4ˆ6, 3ˆ3ˆ1ˆ10ˆp1ˆ6ˆ4q respectively.

The strides for each layers are p2, 1, 2, 1, 1q.

The five capsule layers of P-CapsNets#3 are 3ˆ3ˆ1ˆ1ˆp1ˆ1ˆ32, 3ˆ3ˆ1ˆ4ˆp1ˆ8ˆ16q, 3ˆ3ˆ4ˆ8ˆp1ˆ16ˆ8q, 3ˆ3ˆ8ˆ4ˆp1ˆ8ˆ16, 3ˆ3ˆ4ˆ10ˆp1ˆ16ˆ16q respectively.

The strides for each layers are p2, 1, 2, 1, 1q.

The five capsule layers of P-CapsNets#4 are 3ˆ3ˆ1ˆ1ˆp1ˆ3ˆ32, 3ˆ3ˆ1ˆ4ˆp1ˆ8ˆ16q, 3ˆ3ˆ4ˆ8ˆp1ˆ16ˆ8q, 3ˆ3ˆ8ˆ10ˆp1ˆ8ˆ16, 3ˆ3ˆ10ˆ10ˆp1ˆ16ˆ16q respectively.
...
Then the vector is fed to a fully-connected layer with 3456 output ( the output is reshaped as 3ˆ3ˆ384).
...
The final output of the three deconvolutional layers has the same shape as the input image (28ˆ28) which are the perturbations.
...
s, and α are meta-parameters whose values are 1, 1e´9, and 10.
...
As Table 5 shows, our solution achieves at least 4ˆfaster speed than the CPU mode for different batch sizes.
