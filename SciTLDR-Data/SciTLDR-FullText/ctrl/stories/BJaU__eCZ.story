...
Second, we condition both the discriminator D w and the generator G θ on available labeled data.
...
Referring to the volume labels via y, the objective function L of our ICW-GAN model is as follows: DISPLAYFORM2 wherex DISPLAYFORM3 λ is a gradient penalty coefficient.
