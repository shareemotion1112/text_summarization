...
We then perform an update using the Adam optimizer BID24 , with learning rate λ = 0.0001.
...
We then perform an update using the Adam optimizer BID24 , with learning rate λ = 0.0001, momentum parameters β 1 = 0.9 and β 2 = 0.999, and the stabilizing parameter ε = 10 −8 .
