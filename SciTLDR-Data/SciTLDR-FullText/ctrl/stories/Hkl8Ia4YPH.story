...
where • denotes element-wise multiplication and σ(·) denotes the sigmoid function.
...
where α pg , α entr , α b are hyperparameters, H and MSE denote entropy and mean squared error losses, R t is a state-dependent baseline for reducing variance.
...
We tune the hyperparameters in Eq (3) on the validation set: α pg = 1, α entr = 0.001, α b = 0.01.
