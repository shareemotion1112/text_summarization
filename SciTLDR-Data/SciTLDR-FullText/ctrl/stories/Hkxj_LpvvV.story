...
Then, the objective function of AFLAC is described as follows: DISPLAYFORM0 Here γ denotes a weighting parameter.
...
c, d) show that the accuracy gaps of AFLAC-Abl and AFLAC increase with strong regularization (such as when γ = 10), suggesting that AFLAC, as it was designed, does not tend to reduce accuracy with strong regularizer, and thus AFLAC is robust toward hyperparameter choice.
